...
#  VQD theme is fixed to light mode.
dark = False
...
with col1:
    st.info(
        "**Nuevo en derivados?** → Empieza con la página **BSM** para familiarizarte con los parámetros base: S, K, T, r, σ."
    )

with col2:
    st.info(
        "**Quieres valuar un ticker real?** → Ve directo a **Subyacentes en Vivo** (Pág. 7) e ingresa cualquier símbolo de yfinance."
    )
