...
def portada():
    ...
    with c1:
        ...
        st.markdown("- **[Owen Paredes Conde](https://www.linkedin.com/in/owen-conde-a731b9249/)**")
    with c2:
        st.markdown(
...
pg = st.navigation(
    {
        ...
        "Valuación de Activos y Riesgo": [
            ...
            st.Page("pages/16_Optima_Portafolios.py", title="Optima Portafolios"),
        ],
        ...
        "VQD Derivados Avanzados": [
            st.Page("pages/17_VQD.py", title="VQD Inicio"),
            st.Page("pages/18_VQD_BSM.py", title="VQD BSM"),
            st.Page("pages/19_VQD_CRR.py", title="VQD CRR"),
            st.Page("pages/20_VQD_Heston.py", title="VQD Heston"),
            st.Page("pages/21_VQD_Merton.py", title="VQD Merton"),
            st.Page("pages/22_VQD_Complementos.py", title="VQD Complementos"),
            st.Page("pages/23_VQD_Comparativa.py", title="VQD Comparativa"),
            st.Page("pages/24_VQD_LiveData.py", title="VQD Datos en Vivo"),
            st.Page("pages/25_VQD_SABR.py", title="VQD SABR"),
            st.Page("pages/26_VQD_VG_NIG.py", title="VQD VG/NIG"),
            st.Page("pages/27_VQD_Bachelier_MC.py", title="VQD Bachelier/MC"),
        ],
        "Referencia": [
