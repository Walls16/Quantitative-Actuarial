...
class FinancialMathEngine:
    ...
    def optimizacion_portafolios(self, tickers_list, start_date, end_date, r_f=0.05):
        """
    ...
    # Alias de compatibilidad (por si alguna otra página aún llama al método anterior)
    def optimizacion_markowitz(self, tickers_list, start_date, end_date, r_f=0.05):
        data, mu, S, res, nube = self.optimizacion_portafolios(tickers_list, start_date, end_date, r_f)
        return (data, mu, S,
                res["Máx. Sharpe"],
                res["Mín. Varianza"],
                nube)
